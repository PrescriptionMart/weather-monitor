...
const CACHE = 'pm-weather-v8';
const SHELL = ['./', './index.html', './winter-pack.html', './excursion.html', './excursion-basis.html', './delay-guide.html', './retro.css', './retro.js', './characters.js', './battle.js', './manifest.json', './icon.svg'];
